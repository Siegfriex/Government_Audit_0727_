...
국회 국정감사에서 지적된 시정, 처리요구 사항의 이행 현황을 분석한 결과, 전체 요구 사항 가운데 약 절반은 아직 완전히 이행되지 않은 것으로 나타났다. 

2020년, 2022년, 2024년 각각 연도의 문화체육관광위원회 국정감사 결과에 의하면, 보고서 총 1,566건의 시정-처리요구 사항 중 830건(53.0%)은 조치가 완료됐으며, 736건(47.0%)은 조치 중(향후 조치계획 포함)인 것으로 집계됐다. 

조치 중인 사안과 조치완료인 사안이 비슷한 수치로 나타남은 국정감사에서 지적된 사항이 곧바로 해결되는 것이 아니라 상당수가 장기간 후속 조치를 필요로 한다는 점을 보여준다. 

2024년에는 전체 589건 중 317건(53.8%)이 조치완료, 272건(46.2%)이 조치 중으로 집계됐다. 2022년보다 완료율은 낮아졌지만 2020년보다는 개선된 수준이었다. 

이러한 결과는 국정감사에서 지적된 사항이 곧바로 해결되는 것이 아니라 상당수가 장기간 후속 조치를 필요로 한다는 점을 보여준다. 

특히 연도별 완료율이 33.4%에서 70.7%까지 약 37%포인트 차이를 보인 것은 국정감사의 실질적인 정책 이행 수준이 시기와 사안에 따라 크게 달라질 수 있음을 시사한다.


----

"조치 완료" 보고 뒤에도 반복된 사망사고…서류와 현장의 간극... 

2022년 SPL 평택 제빵공장에서 20대 노동자가 컨베이어 벨트에 끼여 숨지는 사고가 발생하면서 SPC그룹의 산업안전 문제가 사회적 이슈로 떠올랐다. 

사고 이후 고용노동부는 SPC 계열사 전반을 대상으로 특별기획감독을 실시하며 대대적인 안전점검에 착수했다.

감독 결과는 예상보다 심각했다. 산업안전보건법 위반 사항이 수백 건 적발됐으며, 작업장 곳곳에서는 위험기계 안전장치 미설치, 방호장치 미작동, 작업절차 미준수, 위험성 평가 미흡 등 기본적인 안전관리조차 제대로 이루어지지 않은 사실이 확인됐다. 

정부는 이러한 문제들에 대해 시정명령을 내리고 대부분의 사항이 개선됐다고 발표했다.

하지만 이후에도 SPC 계열 사업장에서는 산업재해가 끊이지 않았다. 노동자가 기계에 끼이는 사고와 안전수칙 미준수 사례가 반복됐고, 결국 중대재해가 다시 발생했다. 

국정감사에서 지적된 사항들이 행정적으로는 '조치 완료'로 처리됐지만, 현장에서는 동일한 유형의 위험이 여전히 존재했던 것이다.

이 사례는 행정기관이 사용하는 '조치 완료'라는 표현이 반드시 실제 위험요인이 제거됐다는 의미는 아니라는 점을 보여준다. 

시정조치가 문서상 완료되더라도 현장에서 안전장치가 지속적으로 작동하는지, 작업자들이 새로운 작업절차를 실제로 준수하는지에 대한 사후 관리가 뒤따르지 않으면 같은 사고는 반복될 수 있다.

전문가들은 산업안전 정책의 효과를 평가할 때 단순히 시정조치 건수나 완료율만 볼 것이 아니라, 이후 동일 유형의 사고가 재발했는지, 현장점검 결과가 어떻게 변화했는지를 함께 살펴야 한다고 지적한다.

SPC 사례는 '조치 완료'라는 행정적 결과와 '현장 개선'이라는 실제 성과 사이에 상당한 간극이 존재할 수 있음을 보여주는 대표적인 사례로 평가된다.

---

"조치 중" 3년째…관계기관 협의는 어디까지 왔나

국정감사에서는 대학 체육특기자 입시의 공정성을 높이기 위한 제도 개선 필요성도 제기됐다. 특히 도핑 규정을 위반해 제재를 받은 선수의 이력이 대학 입시에 반영되지 않는 문제를 지적하며, 교육부를 비롯한 관계기관이 공동으로 개선방안을 마련해야 한다는 요구가 나왔다.

당시 정부는 해당 요구에 대해 교육부와 한국대학교육협의회, 한국대학스포츠협의회 등 관계기관이 협의를 거쳐 제도 개선을 검토하겠다고 답변했다. 국회에 제출된 결과보고서에서도 해당 사항은 '조치 중'으로 분류됐다.

그러나 이후 수년이 지난 2026년 현재까지도 관련 협의 결과나 구체적인 제도 개선안은 공식적으로 발표되지 않고 있다. 

교육부·한국대학교육협의회·한국대학스포츠협의회의 공식 자료와 보도자료를 확인해 보았을 때 대학 입시에 도핑 제재 이력을 반영하는 기준이 마련됐다는 발표도, 관계기관 협의가 마무리됐다는 자료도 확인하기 어렵다.

물론 여러 기관이 참여하는 정책은 이해관계 조정과 법적 검토가 필요해 장기간 논의가 이어질 수 있다. 그러나 국정감사에서 개선 필요성이 공식적으로 제기된 사안임에도 추진 과정이나 논의 결과가 국민에게 충분히 공개되지 않는다면 정책의 진행 상황을 확인하기 어렵다.

행정적으로는 '조치 중'이라는 상태가 유지되지만, 실제로 어느 단계까지 논의가 진행됐는지 알기 어려운 것이다. 결과적으로 국민 입장에서는 정책이 추진되고 있는지, 사실상 중단된 것인지조차 판단하기 어렵다.

전문가들은 여러 부처와 기관이 함께 추진하는 정책일수록 협의 과정과 일정, 추진 현황을 주기적으로 공개하는 관리체계가 필요하다고 말한다. 단순히 '조치 중'이라는 행정적 분류만으로는 정책 이행 정도를 객관적으로 판단하기 어렵기 때문이다.

이번 사례는 '조치 중'이라는 행정상 표현이 실제 정책 추진 상황을 충분히 설명하지 못할 수 있다는 점을 보여주는 대표적인 사례다.

---

두 사례를 관통하는 의미

두 사례는 서로 다른 유형의 문제를 보여준다. SPC 사례는 행정적으로는 '조치 완료'됐지만 실제 현장에서는 동일한 문제가 반복될 수 있음을 보여준다. 

반대로 체대 입시 도핑 사례는 '조치 중'이라는 상태가 장기간 유지되면서 실제 정책이 어디까지 추진됐는지 확인하기 어려운 사례다.

즉, 하나는 완료됐지만 효과가 확인되지 않는 문제, 다른 하나는 진행 중이지만 진행 상황 자체를 확인하기 어려운 문제를 드러낸다.

이는 국정감사 결과보고서의 이행 현황이 단순히 '완료', '조치 중', '미조치'와 같은 행정적 분류에 머물러서는 안 된다는 점을 시사한다. 

정책이 실제 현장에서 어떤 변화를 만들었는지, 추진 과정이 국민에게 투명하게 공개되고 있는지를 함께 평가해야만 국정감사의 실효성을 제대로 확인할 수 있다.

이러한 관점에서 두 사례는 '문서상의 이행률'과 '실제 정책 이행' 사이의 간극을 보여주는 대표적 사례로 볼 수 있다.
